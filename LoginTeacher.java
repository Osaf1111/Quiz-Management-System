...
class LoginTeacher extends JFrame implements ActionListener {
    ...
    LoginTeacher() {
        ...
        b2Back.setBounds(40, 40, 80, 40);
        b2Back.setFont(new Font("Josefin Sans", Font.BOLD, 18));
        b2Back.setForeground(Color.white);
        b2Back.setBackground(Color.black);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (e.getSource().equals(b2Back)) {
            // if the user clicks on the back button then the user will be returned to
            // LoginDashboard where he has to select Student or teacher
            new LoginDashboard();
            dispose();
        }
    }
